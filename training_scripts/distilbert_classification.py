...
class TextDataset(Dataset):
    def __init__(self, texts, targets, max_length=180, tokenizer_name='distilbert-base-uncased'):
        self.texts = texts
...
# Save the model
output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../models/fine_tuned_distilbert')
...
metrics_path = os.path.join(BASE_DIR, '../results/distilbert_deployability_metrics.json')
